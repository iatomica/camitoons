...
export const LUNA_IMAGES = {
  ...
  abuelaElsa: getMediaUrl('Imagenes/personajes/arbol de vinculos/Abuela Elsa .webp'),
  abueloAngel: getMediaUrl('Imagenes/personajes/arbol de vinculos/Abuelo angel.webp'),
  hermana: getMediaUrl('Imagenes/personajes/arbol de vinculos/hermana.webp'),
  hermano: getMediaUrl('Imagenes/personajes/arbol de vinculos/hermano.webp'),
  mama: getMediaUrl('Imagenes/personajes/arbol de vinculos/mama.webp'),
  papa: getMediaUrl('Imagenes/personajes/arbol de vinculos/papa.webp'),
  jazmin: getMediaUrl('Imagenes/personajes/arbol de vinculos/jazmin.webp'),
  amigosPares: getMediaUrl('Imagenes/personajes/arbol de vinculos/amigos-pares.webp'),
  lunaCentral: getMediaUrl('Imagenes/personajes/arbol de vinculos/luna.webp'),
  anana: getMediaUrl('Imagenes/personajes/arbol de vinculos/anana.webp'),
  marcos: getMediaUrl('Imagenes/personajes/arbol de vinculos/marcos.webp'),
  prima: getMediaUrl('Imagenes/personajes/arbol de vinculos/prima.webp'),
